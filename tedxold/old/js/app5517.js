      ...
      firstScriptTag.parentNode.insertBefore(tag, firstScriptTag);
		...
		base.determineProvider = function() {
			...
			if (/youtube.com/.test(base.options.video) || /youtu.be/.test(base.options.video)) {
				var videoid = a.href.split('https://www.tedxmilehigh.com/')[3].toString();
				...
				return {
					"provider": "vimeo",
					"id": (a.href.split('https://www.tedxmilehigh.com/')[3].toString()).split('#')[0],
				};
...
UNCODE.fullPage = function() {
	...
	var scrollHashes = function(){
		var hash = window.location.hash.replace('#', '').split('https://www.tedxmilehigh.com/'),
			hashInd;
